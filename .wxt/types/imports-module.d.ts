...
declare module '#imports' {
  ...
  export { Logger } from '../src/components/Logger';
  export { Settings } from '../src/components/Settings';
  export { DEFAULT_SETTINGS, getSettings, setSettings, watchSettings } from '../src/utils/config';
  export { postWorklog } from '../src/utils/jira';
  export { parseLogBlock } from '../src/utils/parser';
  export { TimeUnit, StartTimeMode, ReportingFormat, ParsedEntry, ParseError, ParseResult, LogResult, WorklogRequest, WorklogResponse } from '../src/utils/types';
}
