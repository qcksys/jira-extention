...
export {}
declare global {
  const App: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/components/App').App
  const ContentScriptContext: typeof import('wxt/utils/content-script-context').ContentScriptContext
  const DEFAULT_SETTINGS: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/utils/config').DEFAULT_SETTINGS
  const InvalidMatchPattern: typeof import('wxt/utils/match-patterns').InvalidMatchPattern
  const Logger: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/components/Logger').Logger
  const MatchPattern: typeof import('wxt/utils/match-patterns').MatchPattern
  const Settings: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/components/Settings').Settings
  ...
  const getSettings: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/utils/config').getSettings
  const injectScript: typeof import('wxt/utils/inject-script').injectScript
  const parseLogBlock: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/utils/parser').parseLogBlock
  const postWorklog: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/utils/jira').postWorklog
  const setSettings: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/utils/config').setSettings
  ...
  const watchSettings: typeof import('F:/dev/Libraries/@qcksys/jira-extention/src/utils/config').watchSettings
}
// for type re-export
declare global {
  // @ts-ignore
  ...
  // @ts-ignore
  export type { TimeUnit, StartTimeMode, ReportingFormat, ParsedEntry, ParseError, ParseResult, LogResult, WorklogRequest, WorklogResponse } from 'F:/dev/Libraries/@qcksys/jira-extention/src/utils/types'
  import('F:/dev/Libraries/@qcksys/jira-extention/src/utils/types')
}
